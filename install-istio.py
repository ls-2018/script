...
os.system(rf'''
cd {ISTIO_PATH}
cp ~/resources/tar/{arch}/istio-{version}-osx-{arch}.tar.gz .
...
kubectl apply -f ~/resources/yaml/gateway-api/v1.2.0/standard-install.yaml 
...
kubectl delete -f ~/resources/yaml/gateway-api/v1.2.0/standard-install.yaml
''')
