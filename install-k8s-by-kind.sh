...
# cp ~/data/resources/yaml/flannel/v0.26.5/kube-flannel.yml /tmp/kube-flannel.yml
...
cat ~/data/resources/tar/${ARCH}/nerdctl-2.0.3-linux-${ARCH}.tar.gz | tar -zxvf - -C ./nerdctl
