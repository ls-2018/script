...
helm install cilium /Volumes/Tf/resources/others/cilium-* \
	...
	--set image.repository=$(trans-image-name docker.io/cilium/cilium-ci) \
	--set certgen.image.repository=$(trans-image-name docker.io/cilium/certgen) \
	--set hubble.relay.image.repository=$(trans-image-name docker.io/cilium/hubble-relay-ci) \
	...
	--set nodeinit.image.repository=$(trans-image-name docker.io/cilium/startup-script) \
	--set preflight.image.repository=$(trans-image-name docker.io/cilium/cilium-ci) \
	--set apiserver.image.repository=$(trans-image-name docker.io/cilium/clustermesh-apiserver) \
	--set authentication.mutual.spire.install.initImage.repository=$(trans-image-name docker.io/library/busybox) \
	--set authentication.mutual.spire.install.agent.image.repository=$(trans-image-name ghcr.io/spiffe/spire-agent) \
	--set authentication.mutual.spire.install.agent.image.repository=$(trans-image-name ghcr.io/spiffe/spire-server) \
