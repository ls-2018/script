...
if [ "x86_64" = $(arch) ]; then
    ...
    wget -O /usr/bin/ecli ${GITHUB_PROXY}/github.com/eunomia-bpf/eunomia-bpf/releases/download/v1.0.27/ecli
    wget -O /usr/bin/ecc ${GITHUB_PROXY}/github.com/eunomia-bpf/eunomia-bpf/releases/download/v1.0.27/ecc-x86_64
    wget -O - ${GITHUB_PROXY}/github.com/anakryiko/retsnoop/releases/download/v0.10.1/retsnoop-v0.10.1-amd64.tar.gz | tar -zxvf - && chmod +x ./retsnoop && mv retsnoop /usr/bin/
    wget -O - ${GITHUB_PROXY}/github.com/cilium/pwru/releases/download/v1.0.9/pwru-linux-amd64.tar.gz | tar -zxvf - && chmod +x ./pwru && mv pwru /usr/bin/

else
    wget -O /usr/bin/ecc ${GITHUB_PROXY}/github.com/eunomia-bpf/eunomia-bpf/releases/download/v1.0.27/ecc-aarch64
    wget -O /usr/bin/ecli ${GITHUB_PROXY}/github.com/eunomia-bpf/eunomia-bpf/releases/download/v1.0.27/ecli-aarch64
    wget -O - ${GITHUB_PROXY}/github.com/anakryiko/retsnoop/releases/download/v0.10.1/retsnoop-v0.10.1-arm64.tar.gz | tar -zxvf - && chmod +x ./retsnoop && mv retsnoop /usr/bin/
    wget -O - ${GITHUB_PROXY}/github.com/cilium/pwru/releases/download/v1.0.9/pwru-linux-arm64.tar.gz | tar -zxvf - && chmod +x ./pwru && mv pwru /usr/bin/
